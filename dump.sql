...
INSERT INTO `Attendance` VALUES ('2020-11-21',100025,1,''),('2020-11-21',100030,1,'');
...
INSERT INTO `Complaint` VALUES (1,'2020-11-21','20:33:38','No electricity','There is no electricity in our classroom.','Fixed it',1,100001);
...
) ENGINE=InnoDB AUTO_INCREMENT=100048 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Enrollment` VALUES (1,100001,'B1','C01',1,NULL,NULL);
...
INSERT INTO `Payroll` VALUES ('IGAD82491','1',2018,5000.50,'2020-10-10',100025);
...
) ENGINE=InnoDB AUTO_INCREMENT=100070 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Result` VALUES (100001,1,5,1,0,''),(100062,1,9,0,0,NULL),(100063,1,0,1,0,''),(100068,1,8,0,0,NULL),(100069,1,10,1,0,'');
...
) ENGINE=InnoDB AUTO_INCREMENT=100124 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Teacher` VALUES (15,'Male','1992-08-21','663','Bodhwan talab khaira road jamui ,','Jamui','Bihar','','','',100025,'COMP'),(16,'Male','1973-04-03','614','QTR 4307 A IOCL PARADIP REFINERY TOWNSHIP , JAGATSINGHPUR DISTRICT','PARADIP','ODISHA',NULL,NULL,NULL,100026,'MATH'),(17,'Male','1976-03-22','891','14-4-259, Joshiwadi, Begum Bazar, Near Deepa Hospital ,','HYDERABAD','TELANGANA',NULL,NULL,NULL,100028,'MATH'),(18,'Male','1977-08-01','175','VILLAGE + POST - KANTA , Via - Keotasha Baruari','Muzaffarpur','Bihar',NULL,NULL,NULL,100029,'MATH'),(19,'Male','1972-02-15','29','942 , ISLAMNAGAR','SAHARANPUR','UTTAR PRADESH',NULL,NULL,NULL,100032,'MATH'),(20,'Male','1972-08-28','273','C-39, LAJPAT MARG, , C-SCHEME','Jaipur','Rajasthan',NULL,NULL,NULL,100033,'MATH'),(21,'Male','1999-09-02','153','Sardarpura ward no. 1 ,','Barmer','Rajasthan',NULL,NULL,NULL,100034,'MATH'),(22,'Male','1981-11-01','15','A 336/I CHANDRAVARDAI NAGAR ,','Ajmer','RAJASTHAN',NULL,NULL,NULL,100036,'MATH'),(23,'Female','1996-04-18','496','Kalambagh Road ,Gannipur, Bangali Colony, Near Vypaar mandal ,','Muzaffarpur','BIHAR',NULL,NULL,NULL,100037,'MATH'),(24,'Male','2000-08-21','853','Street no.-23 Qrs. no.-74/A , Chittaranjan','Chittaranjan','West Bengal',NULL,NULL,NULL,100038,'MATH'),(25,'Male','1998-12-21','938','BHAKTI KUNJ, 16/6 Gundawadi Corner, , Rajkot','Rajkot','Gujarat',NULL,NULL,NULL,100039,'MATH'),(26,'Male','1974-01-15','22','VAISHNAVI NAGAR COLONY CHANDPUR , INDUSTRIAL ESTATE VARANASI','Varanasi','UTTAR PRADESH',NULL,NULL,NULL,100040,'MATH'),(27,'Male','1997-02-01','269','A-4, Pride Galaxy, B/H Ryan International School , Itkheda, Paithan Road','Aurangabad','Maharashtra',NULL,NULL,NULL,100041,'MATH'),(28,'Male','1996-01-21','254','KHAIRUDDINPUR CHUNAR , CHUNAR MIRZAPUR','CHUNAR','UTTAR PRADESH',NULL,NULL,NULL,100043,'MATH'),(29,'Not Specified','1983-10-26','818','VILL:GODHIYARI, P.O. RAGHOPUR, BLOCK:MANIGACHHI DIST:DARBHANGA,BIHAR PIN CODE:847239 ,','darbhanga','Bihar',NULL,NULL,NULL,100044,'MATH'),(30,'Male','1994-04-14','635','1832/1 DICROUZ COMPOUND MASIHA GANJ , NEAR ILAHI BABA KI MAZAR , SIPRI BAZAR , JHANSI ,','JHANSI','UTTAR PRADESH',NULL,NULL,NULL,100045,'MATH'),(31,'Female','1987-06-28','238','vill-MIRDAHACHAK, p.o.-POARI, p.s.-HARNAUT, dist.-NALANDA, state-BIHAR ,','BIHAR SHARIF','BIHAR',NULL,NULL,NULL,100046,'MATH'),(32,'Female','1992-12-27','78','14-4-259, Joshiwadi, Begum Bazar, Near Deepa Hospital ,','HYDERABAD','TELANGANA',NULL,NULL,NULL,100047,'MATH');
...
INSERT INTO `Test` VALUES (1,'Sample Test',10,'2020-11-24','10:20:00','10:30:00',10,'Easy','C01');
...
INSERT INTO `Transaction` VALUES (1,10000.00,'2020-11-24','18:34:05','Offline',0);
...
-- Dump completed on 2020-11-24 19:00:16
